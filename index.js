...
async function run() {
    try {
        ...
        app.delete('/bookingDelete/:id', verifyJWT, async (req, res) => {
            const id = req.params.id;
...
app.get('/', async (req, res) => {
    res.send('Appointment portal server is running');
})

app.listen(port, () => console.log(`Appointment portal running on ${port}`))